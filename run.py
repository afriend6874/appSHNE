...
def get_eda_args(args_passed, all_args):
    ...
    args={}
    # all_args_keys=list(all_args.keys())
    ...
    for arg in all_args.keys():
        ...
        if arg=="limit":
            ...
            args[arg]=get_tags(test_args, argument_str)
        idx+=1
    return args
...
def apply_command_line_args(args, params):
    ...
    if EDA:
        ...
        eda_params={
            ...
            "data_naming_key":eda_params["data_naming_key"],
        ...
        if eda_args_passed["time"]:
            ...
            time_func(Main.run_eda, eda_params)
        else:
            Main.run_eda(**eda_params)
        sys.exit()
